...
export function NavItem({ title, icon: Icon }: NavItemProps) {
	return (
		<a
			href=''
			className='outline-none focus-visible:border-violet-300 focus-visible:ring-4 
			focus-visible:ring-violet-100 group flex items-center gap-3 rounded px-3 py-2 hover:bg-violet-50
